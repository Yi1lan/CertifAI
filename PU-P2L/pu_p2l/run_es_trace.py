...
TRACE_METHODS = ["MaxLoss", "Marginal", "PU-R", "PU-R-Vol", "PU-R-Manifold", "GREATS"]
TRACE_FIELDS = [
    "method",
    "dataset",
    "seed",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pretrain-fractions", type=float, nargs="+", default=[0.0])
    parser.add_argument("--methods", type=str, nargs="+", default=TRACE_METHODS)
    parser.add_argument(
        "--record-every",
        type=int,
        default=5,
