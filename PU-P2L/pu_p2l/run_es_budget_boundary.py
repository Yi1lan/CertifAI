...
ES_BUDGET_METHODS = ["MaxLoss", "Marginal", "PU-R", "PU-R-Vol", "PU-R-Manifold", "GREATS"]
ES_BUDGET_FIELDS = [
    "method",
    "dataset",
    "seed",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=str, default="results/synthetic_redundancy_hard/es_budget_boundary")
